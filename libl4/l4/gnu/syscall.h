...

/* IPC errors.  */
#define L4_IPC_TIMEOUT			_L4_IPC_TIMEOUT
#define L4_IPC_NO_PARTNER		_L4_IPC_NO_PARTNER
#define L4_IPC_CANCELED			_L4_IPC_CANCELED
#define L4_IPC_MSG_OVERFLOW		_L4_IPC_MSG_OVERFLOW
#define L4_IPC_XFER_TIMEOUT_INVOKER	_L4_IPC_XFER_TIMEOUT_INVOKER
#define L4_IPC_XFER_TIMEOUT_PARTNER	_L4_IPC_XFER_TIMEOUT_PARTNER
#define L4_IPC_ABORTED			_L4_IPC_ABORTED
