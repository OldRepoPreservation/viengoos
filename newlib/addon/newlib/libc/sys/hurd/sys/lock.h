...
#define __lock_release(l) __lock_release_ (&(l))

extern void __lock_acquire_ (_LOCK_T *lockp);
#define __lock_acquire(l) __lock_acquire_(&l)

/* Returns 0 if the lock was acquired.  */
extern int __lock_try_acquire_ (_LOCK_T *lockp);
#define __lock_try_acquire(l) __lock_try_acquire_(&l)
...
#define __lock_acquire_recursive(l) __lock_acquire_recursive_(&(l))

/* Returns 0 if the lock was acquired.  */
extern int __lock_try_acquire_recursive_ (_LOCK_RECURSIVE_T *lockp);
#define __lock_try_acquire_recursive(l) __lock_try_acquire_recursive_ (&(l))

extern void __lock_release_recursive_ (_LOCK_RECURSIVE_T *lockp);
#define __lock_release_recursive(l) __lock_release_recursive_ (&(l))
