...
extern const word_ma_t environment_kip[];
extern word_t __attribute__((__unused__)) environment_api_version;
extern word_t __attribute__((__unused__)) environment_api_flags;
extern word_t __attribute__((__unused__)) environment_kernel_id;

/* 64 MRs forwards, 16 UTCB words and 33 BRs backwards.  */
extern word_t environment_utcb[];
extern word_t *environment_utcb_address;

...
#ifdef __i386__
const word_ma_t environment_kip[] = 
  {
...
word_t __attribute__((__unused__)) environment_api_version = 0x84050000;
word_t __attribute__((__unused__)) environment_api_flags = 0x00000000;
word_t __attribute__((__unused__)) environment_kernel_id = 0x04020000;

/* 64 MRs forwards, 16 UTCB words and 33 BRs backwards.  */
word_t environment_utcb[64 + 16 + 33];
word_t *environment_utcb_address = &environment_utcb[33 + 16];
#else
#error not ported to this architecture
#endif
...
#endif
  environment_utcb_address[_L4_UTCB_MY_GLOBAL_ID] = l4_global_id (100, 1);
